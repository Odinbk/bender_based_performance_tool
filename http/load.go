...
import (
	...
	OD "git.appannie.org/appannie/performance/http/cases/test_plan/1_dimension"
	TWD "git.appannie.org/appannie/performance/http/cases/test_plan/2_dimensions"
	TRD "git.appannie.org/appannie/performance/http/cases/test_plan/3_dimensions"
	FD "git.appannie.org/appannie/performance/http/cases/test_plan/4_dimensions"
	"strings"
	"flag"
	"fmt"
)
...
func generateTestGroupMapping(c *Config) map[string]interface{} {
	data := map[string]interface{}{
		"user_id":     c.UserId,
		"product_ids": fmt.Sprintf("[%s]", strings.Join(c.ProductIds, ",")),
		"interval":    c.Interval,
		"repeat":      c.Repeat,
		"method":      c.Method,
